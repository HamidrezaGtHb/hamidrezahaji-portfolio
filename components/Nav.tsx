...
export const CV = '/Hamidreza-Haji-CV.pdf';
  ...
  return (<>
    <nav className={s.nav} style={{ animationDelay: delay }}>
      ...
      <div className={s.links}>
        ...
        <a href={CV} download className={s.contact}>{d.contact.resume} <small>↓</small></a>
      </div>
    ...
    {open && <div className={s.menu}>
      <div className={s.menuList}>
        ...
        <a href={CV} download className={'display ' + s.menuItem}>{d.contact.resume}<span className={s.count}>PDF ↓</span></a>
      </div>
